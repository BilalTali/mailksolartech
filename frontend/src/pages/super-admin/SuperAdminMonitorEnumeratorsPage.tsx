                                    ...
                                    <td className="px-6 py-5 relative">
                                        {enm.parentAgent ? (
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-sm font-bold text-slate-800 leading-tight">{enm.parentAgent.name}</span>
                                                <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-tighter">{enm.parentAgent.agent_id}</span>
                                            </div>
                                        ) : enm.createdBySuperAgent ? (
                                            <div className="flex flex-col">
