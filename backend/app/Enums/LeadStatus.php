...
enum LeadStatus: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::REGISTERED             => 'REGISTRED AT MNRE.',
            ...
            self::SIGNATURE_DONE         => 'CONSUMER SINGNATURE DONE',
            self::FILE_SUBMITTED_TO_BANK => 'FILE SUBMITTED TO BANK',
            self::FILE_PENDING_DISBURSAL => 'FILE PENDING DISBURSAL',
            self::FILE_DISBURSED         => 'FILE DISBURSED SUCUESSFULLY',
            self::DISBURSEMENT_VERIFIED  => 'DISBURSEMENT VARIFIED BY ADMIN',
            self::DISPATCH_INITIATED     => 'MATERIAL DISPATCH INITATED',
            self::IN_TRANSIT             => 'MATERIAL IN TRANSIT',
            self::DELIVERED              => 'MATERIAL DELIVERED',
            self::MATERIAL_VERIFIED_BY_CONSUMER  => 'MATERIEL VARIEFIED BY CONSUMER',
            self::INSTALLATION_SCHEDULED => 'INSTALLATION SCHUDULED',
            self::INSTALLATION_IN_PROGRESS => 'INSTALLATION IN PROGRESS',
            self::SOLAR_INSTALLED        => 'SOLAR INSTALLED SUCUESSFULLY',
            self::POD_INSPECTION_INITIATED => 'POD INSPECTION SCHUDULED',
            ...
            self::SUBSIDY_REQUEST        => 'SUBSITY REQUEST FILED',
            self::SUBSIDY_APPLIED        => 'SUBSIDY APPLIED',
            self::SUBSIDY_DISBURSED      => 'SUBSSITY DISBURSED',
